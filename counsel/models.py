...
class CounselComment(models.Model):
    user = models.ForeignKey(
        ...
        related_name="counsel_comment_user",
    )
    counsel = models.ForeignKey(
        Counsel, on_delete=models.CASCADE, related_name="counsel_comment_counsel"
    )
    content = models.TextField(verbose_name="내용")
    like = models.ManyToManyField(
        User, related_name="counsel_comment_like", verbose_name="좋아요"
    )
    created_at = models.DateTimeField(
        verbose_name="작성일",
        auto_now_add=True,
...
class CounselReply(models.Model):
    user = models.ForeignKey(
        ...
        verbose_name="댓글작성자",
        on_delete=models.CASCADE,
        related_name="counsel_reply_user",
    )
    ...
    content = models.TextField(verbose_name="내용")
    like = models.ManyToManyField(
        User, related_name="counsel_reply_like", verbose_name="좋아요"
    )
    created_at = models.DateTimeField(
        verbose_name="작성일",
        auto_now_add=True,
